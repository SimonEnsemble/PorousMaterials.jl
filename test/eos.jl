...
using PorousMaterials, Test, Polynomials
...
@testset "equation of state (eos.jl) Tests" begin
    ...
    props = calculate_properties(fluid, 150.0, 50.0; verbose=false)
    ...
    props = calculate_properties(fluid, 298.0, 50.0; verbose=false)
