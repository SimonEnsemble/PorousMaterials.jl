...
@testset "VdwEnergetics Tests" begin
    ...
    for c in 1:4 # four configurations
    ...
    r²_oo = (2.0 * 1.16)^2
    energy = (
        2.0 * lennard_jones(r²_com, ljff.σ²[:O_CO2][:O_CO2], ljff.ϵ[:O_CO2][:O_CO2]) +
        4.0 *
        lennard_jones(r²_com + r²_co, ljff.σ²[:O_CO2][:C_CO2], ljff.ϵ[:O_CO2][:C_CO2]) +
        2.0 *
        lennard_jones(r²_com + r²_oo, ljff.σ²[:O_CO2][:O_CO2], ljff.ϵ[:O_CO2][:O_CO2]) +
    ...
    r²_co = (13.0 - 1.16)^2
    energy = (
        lennard_jones(r²_o, ljff.σ²[:O_CO2][:O_CO2], ljff.ϵ[:O_CO2][:O_CO2]) +
    ...
    energy_12 =
        4.0 *
        ljff.ϵ[:Xe][:Xe] *
        ((ljff.σ²[:Xe][:Xe] / r12_sqr)^6 - (ljff.σ²[:Xe][:Xe] / r12_sqr)^3)
    energy_13 =
        4.0 *
        ljff.ϵ[:Xe][:Kr] *
        ((ljff.σ²[:Xe][:Kr] / r13_sqr)^6 - (ljff.σ²[:Xe][:Kr] / r13_sqr)^3)
